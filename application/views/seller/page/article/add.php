            ...
            <form id="CreateBlog" class="form-horizontal form-label-left validator" method="POST" action="" novalidate>
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <select name="blog[]" id="" class="select2 form-control" multiple="multiple" >
                    <?php foreach($blogs as $blog): ?>
                      <option value="<?php echo $blog->id ?>" <?php echo isset($_GET['blog_id']) && $_GET['blog_id'] == $blog->id ? 'selected' : '' ?>><?php echo $blog->title ?></option>
                    <?php endforeach; ?>
                  </select> 
                </div>
              </div><!-- 
              ...
              <div class="form-group item">
                <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                  ...
                  <button type="submit"  name="submit"  class="btn btn-success">Tạo bài viết</button>
                </div>
              </div>
