              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="type" id="linkTypeSelect" class="select2 form-control">
                    <option value="/admin/blogs" <?php echo isset($form_data['target_type']) && $form_data['target_type']==='BLOG' ? 'selected' : '' ?>>Blog</option>
                    <option value="/admin/articles" <?php echo isset($form_data['target_type']) && $form_data['target_type']==='ARTICLE' ? 'selected' : '' ?>>Bài viết</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="target" id="linkTargetSelect" class="form-control">
                    <option selected="selected" value="<?php echo $form_data['target_id']; ?>"><?php echo $form_data['target_object']->title; ?></option>
                  </select>
                </div>
              </div>
